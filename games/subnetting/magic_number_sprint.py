#!/usr/bin/env python3
"""
Magic Number Sprint v2.3 — Difficulty Edition
---------------------------------------------
Includes:
 • Difficulty selector (Casual / Standard / Speedrun)
 • Dynamic timer scaling per difficulty
 • Tutorial round
...
def main():
    data=load_scores()
    while True:
        print("=== Magic Number Sprint v2.3 ===")
